...
import {
  BarChart, Bar, Label, LabelList, XAxis, YAxis, CartesianGrid, Tooltip, Legend,
} from 'recharts'

import * as Styled from '../StyledComponents/Chart'
...
const Results = () => <div>
  ...
  1. About two-third (63%) participants in our study believed that windmills degrade the
  visual landscape.
  2. More than two-third (69%) participants in our study expected to be annoyed by the
  noise produced by windmills.
  3. House owners and house renters differ somewhat in their perceptions of what
  constitutes a fair compensation for installing windmill projects in their neighbourhoods.
  4. Current proximity to a windmill significantly predicted public support – those who
  currently lived near to a windmill reported lower social acceptance of wind energy
  projects.
  5. The belief that windmills play a key role in successful energy transition also
  predicted greater public support towards wind energy projects.
</Typography>
</div>
